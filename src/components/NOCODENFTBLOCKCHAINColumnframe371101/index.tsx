...
type NOCODENFTBLOCKCHAINColumnframe371101Props = Omit<
...
const NOCODENFTBLOCKCHAINColumnframe371101: React.FC<
  NOCODENFTBLOCKCHAINColumnframe371101Props
> = (props) => {
  return (
    <>
...
NOCODENFTBLOCKCHAINColumnframe371101.defaultProps = {
...
export default NOCODENFTBLOCKCHAINColumnframe371101;
