...
type NOCODENFTHomepageColumnframe371101Props = Omit<
...
const NOCODENFTHomepageColumnframe371101: React.FC<
  NOCODENFTHomepageColumnframe371101Props
> = (props) => {
  return (
    <>
      <div className={props.className}>
        <Img
          ...
          src="images/img_frame371101.svg"
          alt="frame371101"
        />
        <List
          className="bg-black-900 sm:flex-col flex-row gap-4 grid sm:grid-cols-1 md:grid-cols-3 grid-cols-6 justify-start shadow-bs w-auto md:w-full"
          orientation="horizontal"
        >
          <div className="bg-black-900 flex flex-col items-center justify-start px-4 py-8 rounded-lg shadow-bs w-[200px]">
            <div className="flex flex-col items-center justify-start shadow-bs w-auto">
              <Text
...
NOCODENFTHomepageColumnframe371101.defaultProps = {
...
export default NOCODENFTHomepageColumnframe371101;
