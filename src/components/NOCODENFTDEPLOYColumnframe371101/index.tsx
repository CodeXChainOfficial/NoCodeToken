...
type NOCODENFTDEPLOYColumnframe371101Props = Omit<
...
const NOCODENFTDEPLOYColumnframe371101: React.FC<
  NOCODENFTDEPLOYColumnframe371101Props
> = (props) => {
  return (
    <>
      <div className={props.className}>
        <Img
          ...
          src="images/img_frame371101_light_blue_500.svg"
          alt="frame371101"
        />
        <List
...
NOCODENFTDEPLOYColumnframe371101.defaultProps = {
...
export default NOCODENFTDEPLOYColumnframe371101;
