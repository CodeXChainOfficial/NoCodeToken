...
type CodeXDAOGovernanceOneRowframe370831Props = Omit<
...
const CodeXDAOGovernanceOneRowframe370831: React.FC<
  CodeXDAOGovernanceOneRowframe370831Props
> = (props) => {
  return (
    <>
      <div className={props.className}>
        ...
        <div className="flex md:flex-col flex-row gap-12 items-center justify-start w-auto md:w-full">
          ...
          <Button className="bg-gradient  capitalize cursor-pointer font-raleway font-semibold min-w-[160px] py-[11px] rounded text-base text-center text-white-A700 tracking-[0.80px]">
...
CodeXDAOGovernanceOneRowframe370831.defaultProps = {
...
export default CodeXDAOGovernanceOneRowframe370831;
