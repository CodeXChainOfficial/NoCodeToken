...
const ForumcodexprojectsPage: React.FC = () => {
  return (
    <>
        ...
        <div className="flex flex-col gap-8 items-center w-full">
          ...
          <div className="flex md:flex-col flex-row gap-8 items-start justify-start max-w-[1440px] md:px-10 px-20 sm:px-5 w-full">
            <div className="flex sm:flex-1 flex-col gap-4 items-start justify-start w-[401px] sm:w-full">
              ...
              <div className="flex flex-col items-start justify-start w-[401px] sm:w-full">
                <div className="bg-black-900_01 border-l-[10px] border-orange-300 border-solid flex flex-col gap-4 items-start justify-start sm:px-5 px-8 py-4 rounded-lg w-full">
                      ...
                      <div className="flex md:flex-col flex-row gap-[37px] items-center justify-between w-[98%] md:w-full">
                        <div className="flex flex-col items-center justify-start w-[49%] md:w-full">
                          ...
                          <div className="flex sm:flex-col flex-row gap-4 items-start justify-start w-auto sm:w-full">
                            <Text
                              className="bg-black-900_01 capitalize justify-center pb-1 pt-[7px] px-1 rounded text-orange-300 text-xs tracking-[0.60px] w-auto"
...
export default ForumcodexprojectsPage;
