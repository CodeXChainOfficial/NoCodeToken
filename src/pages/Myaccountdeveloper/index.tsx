...
const MyaccountdeveloperPage: React.FC = () => {
  ...
  return (
    <>
      <div className="bg-black-900 flex flex-col font-raleway items-start justify-start mx-auto w-full">
        ...
        <div className="bg-black-900 flex flex-col items-start justify-start mt-8 md:px-5 w-auto md:w-full">
        ...
        <div className="flex flex-col items-center mt-16 w-full">
          ...
          <div className="bg-black-900 flex flex-col gap-2 items-start justify-start max-w-7xl mt-16 mx-auto md:px-5 w-full">
            ...
            <div className="flex flex-col gap-8 items-start justify-start w-full">
              <div
                className="common-pointer bg-black-900_01 flex flex-row gap-2.5 items-center justify-between sm:px-5 px-8 py-4 rounded-lg w-full"
          ...
          <Footer className="bg-gray-900 flex font-inter gap-8 items-center justify-center mt-80 px-20 md:px-5 py-4 w-full" />
        </div>
      </div>
    </>
  );
...
export default MyaccountdeveloperPage;
