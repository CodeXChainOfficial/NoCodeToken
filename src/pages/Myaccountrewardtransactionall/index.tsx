...
const MyaccountrewardtransactionallPage: React.FC = () => {
  ...
  const table7Columns = React.useMemo(() => {
    ...
    return [
      table7ColumnHelper.accessor("nameofproject", {
        cell: (info) => (
      ...
      table7ColumnHelper.accessor("earnedtoken", {
        cell: (info) => (
...
export default MyaccountrewardtransactionallPage;
