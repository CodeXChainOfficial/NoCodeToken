...
import TokenGenerationFooterexplorer from "components/TokenGenerationFooterexplorer";

const TokengenerationPage: React.FC = () => {
  return (
    <>
      <div className="bg-black-900 flex flex-col font-raleway items-center justify-start mx-auto w-full">
        <header className="bg-black-900 flex md:flex-col md:gap-10 items-center justify-between px-20 md:px-5 w-full">
          ...
          <div className="bg-black-900 flex sm:flex-1 flex-row gap-12 items-center justify-start w-auto sm:w-full">
            <ul className="flex flex-row gap-8 sm:hidden items-start justify-start w-auto common-row-list">
              <li>
                ...
                >
                  <Text size="txtRalewayRomanSemiBold16WhiteA700">token</Text>
                </a>
              </li>
              <li>
                <a
                ...
                >
                  <Text size="txtRalewayRomanSemiBold16WhiteA70099">
                    N0-code
                  </Text>
                </a>
              </li>
              <li>
                <a
                  ...
                  className="capitalize text-base hover:text-white-A700 text-white-A700_99 tracking-[0.80px]"
                >
                  <Text size="txtRalewayRomanSemiBold16WhiteA70099">dAO</Text>
                </a>
              </li>
              <li>
                <a
                  ...
                  className="capitalize text-base hover:text-white-A700 text-white-A700_99 tracking-[0.80px]"
                >
                  <Text size="txtRalewayRomanSemiBold16WhiteA70099">doc</Text>
                </a>
              </li>
            </ul>
        ...
        <div className="bg-black-900_01 flex flex-col gap-8 items-end justify-start max-w-7xl mx-auto p-8 md:px-5 rounded-lg w-full">
              ...
              <div className="flex flex-1 flex-col gap-4 items-start justify-start w-full">
                ...
                <div className="flex flex-col gap-4 items-start justify-start w-full">
                  ...
                  <Input
                    ...
                    className="capitalize font-semibold p-0 placeholder:text-white-A700_4c sm:pr-5 text-base text-left text-white-A700_4c tracking-[0.80px] w-full"
                    wrapClassName="border border-solid border-white-A700_19 pb-[9px] pl-4 pr-[35px] pt-[13px] rounded-lg w-full"
                  ></Input>
                </div>
                <div className="flex flex-col gap-4 items-start justify-start w-full">
                  <Text
        ...
        <TokenGenerationFooterexplorer className="bg-gray-900 flex flex-col font-inter gap-8 items-center justify-start max-w-[1440px] mt-[115px] md:px-10 px-20 sm:px-5 py-12 w-full" />
      </div>
    </>
  );
};
