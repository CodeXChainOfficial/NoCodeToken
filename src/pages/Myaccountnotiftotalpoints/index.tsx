...
const MyaccountnotiftotalpointsPage: React.FC = () => {
    ...
    <>
      <div className="bg-black-900 flex flex-col font-raleway items-center justify-start mx-auto w-full">
        ...
        <div className="h-[399px] sm:h-[465px] md:h-[705px] mt-8 md:px-5 relative w-full">
          ...
          <Input
            name="description"
            placeholder=" Your total points in the forum discussion are based on the contributions you make and the community&#39;s assessment of your trustworthiness. If the community approves you as a credible individual, you can earn points. However, please note that the community has the authority to report and ban users for providing misleading information or engaging in harassment. In case of violations, your account may be subject to a ban. Accumulating higher points can also result in earning badges that recognize your credibility within the community."
            className="font-semibold leading-[160.00%] p-0 placeholder:text-white-A700 text-left text-white-A700 text-xs tracking-[0.60px] w-full"
            wrapClassName="absolute bg-blue_gray-900_cc p-2.5 right-[6%] rounded-lg top-[14%] w-[36%]"
          ></Input>
        </div>
...
export default MyaccountnotiftotalpointsPage;
