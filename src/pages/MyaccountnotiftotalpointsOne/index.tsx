...
const MyaccountnotiftotalpointsOnePage: React.FC = () => {
    ...
    <>
      <div className="bg-black-900 flex flex-col font-raleway items-center justify-start mx-auto w-full">
        ...
        <div className="h-[399px] sm:h-[465px] md:h-[705px] mt-8 md:px-5 relative w-full">
          ...
          <div className="absolute bg-blue_gray-900_cc flex flex-col items-center justify-start p-2.5 right-[18%] rounded-lg top-[20%] w-[326px]">
            <Text
              className="leading-[160.00%] max-w-[306px] md:max-w-full text-white-A700 text-xs tracking-[0.60px]"
              size="txtRalewayRomanSemiBold12WhiteA700"
            >
              <>
                Total points: Earn points in the forum by contributing and
                gaining the community&#39;s trust. However, remember to provide
                accurate information and avoid harassment to maintain a positive
                reputation. Higher points lead to credibility badges.
              </>
            </Text>
          </div>
        </div>
...
export default MyaccountnotiftotalpointsOnePage;
