...
const ForumcodexprojectsalldetailOnePage: React.FC = () => {
  return (
    <>
      <div className="bg-black-900 flex flex-col font-raleway items-start justify-start mx-auto w-full">
        <div className="flex flex-col gap-8 items-center w-full">
          ...
          <div className="bg-black-900 flex flex-col items-start justify-start max-w-[1438px] md:px-10 px-20 sm:px-5 py-4 w-full">
            <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between max-w-[1278px] mx-auto w-full">
              <div className="flex sm:flex-1 sm:flex-col flex-row gap-8 items-center justify-start w-auto sm:w-full">
                <Button
                  className="bg-black-900 border border-solid border-white-A700_19 cursor-pointer flex items-center justify-center min-w-[166px] px-[31px] py-[11px] rounded-lg"
                  rightIcon={
                    <Img
                ...
                >
                  <div className="capitalize font-semibold sm:px-5 text-left text-white-A700_99 text-xl tracking-[1.00px]">
                    project
                  </div>
                </Button>
                <Button
          ...
          <div className="flex md:flex-col flex-row gap-8 items-start justify-start max-w-[1440px] md:px-10 px-20 sm:px-5 w-full">
            <div className="flex sm:flex-1 flex-col gap-4 items-start justify-start w-[401px] sm:w-full">
              ...
              <div className="bg-black-900_01 border-deep_purple-A200 border-l-[10px] border-solid flex flex-col gap-4 items-start justify-start sm:px-5 px-8 py-4 rounded-lg w-full">
                ...
                >
                  This category is about infrastructure. Here is a list of Aptos
                  Incentivized Testnet 2 (AIT-2) validator profiles, where you
                  may review details, ask questions, and further discuss
                  relevant issues.
                </Text>
                <div className="flex flex-row gap-4 items-center justify-between w-full">
                  <div className="flex flex-col items-start justify-start w-auto">
                ...
                <div className="bg-black-900_01 flex flex-1 flex-col items-center justify-between px-4 py-2 rounded-lg w-full">
                  <div className="flex flex-col items-center justify-start max-w-[795px] w-full">
                    <div className="flex flex-col items-start justify-start w-full">
                      <div className="flex md:flex-col flex-row gap-[30px] items-center justify-between w-[98%] md:w-full">
                        <div className="flex flex-col items-center justify-start w-1/2 md:w-full">
                          ...
                          <div className="flex sm:flex-col flex-row gap-4 items-center justify-start w-auto sm:w-full">
                            <Button
                              className="bg-black-900_01 cursor-pointer flex items-center justify-center min-w-[80px] px-1 rounded"
                              leftIcon={
                                <Img
                                  className="h-4"
                            ...
                            >
                              <div className="capitalize font-semibold text-left text-white-A700 text-xs tracking-[0.60px]">
                                12 votes{" "}
                              </div>
                            </Button>
                            <Text
                              className="bg-black-900_01 capitalize justify-center pb-1 pt-[7px] px-1 rounded text-deep_purple-A200 text-xs tracking-[0.60px] w-auto"
                              size="txtRalewayRomanSemiBold12DeeppurpleA200"
                            >
                              Node Operations
                            </Text>
                            <Text
        ...
        <div className="flex flex-col items-end mt-24 md:px-10 sm:px-5 px-[90px] w-full">
        ...
        <div className="flex flex-col font-inter items-center mt-20 w-full">
...
export default ForumcodexprojectsalldetailOnePage;
