...
const AccountsuccesscontributordeveloperPage: React.FC = () => {
  return (
    <>
                ...
                <div className="flex flex-col items-start justify-start w-auto md:w-full">
                  <div className="flex md:flex-col flex-row md:gap-10 gap-20 items-start justify-start w-full">
                    <div className="flex flex-1 flex-col gap-4 items-end justify-end w-full">
                      ...
                      <Button className="bg-gradient  capitalize cursor-pointer font-semibold min-w-[101px] py-[11px] rounded text-base text-center text-white-A700 tracking-[0.80px]">
                        Register
                      </Button>
                    </div>
          ...
          <div className="absolute bg-black-900_01 flex flex-col inset-x-[0] items-center justify-center max-w-[680px] mx-auto p-8 sm:px-5 rounded-[16px] top-[1%] w-full">
            ...
            <div className="flex flex-col gap-8 items-end justify-start w-auto md:w-full">
              ...
              <div className="flex flex-row gap-4 items-start justify-start w-auto">
                <Button className="bg-gradient  capitalize cursor-pointer font-semibold min-w-[128px] py-[11px] rounded text-base text-center text-white-A700 tracking-[0.80px]">
                  My Account
                </Button>
...
export default AccountsuccesscontributordeveloperPage;
