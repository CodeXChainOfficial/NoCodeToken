...
const ForumcodexsuggestionPage: React.FC = () => {
  return (
    <>
      <div className="bg-black-900 flex flex-col font-raleway items-start justify-start mx-auto w-full">
        <div className="flex flex-col gap-8 items-center w-full">
          ...
          <div className="bg-black-900 flex flex-col h-20 md:h-auto items-start justify-between max-w-[1438px] md:px-10 px-20 sm:px-5 py-4 w-full">
            <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between max-w-[1278px] mx-auto w-full">
              <div className="flex flex-row gap-8 items-center justify-start w-auto">
                <Button
                  className="bg-black-900 border border-solid border-white-A700_19 cursor-pointer flex items-center justify-center min-w-[209px] px-[31px] py-[11px] rounded-lg"
                  rightIcon={
                    <Img
          ...
          <div className="flex md:flex-col flex-row gap-8 items-start justify-start max-w-[1440px] md:px-10 px-20 sm:px-5 w-full">
            <div className="flex sm:flex-1 flex-col gap-4 items-start justify-start w-[401px] sm:w-full">
              ...
              <div className="bg-black-900_01 border-l-[10px] border-pink-300 border-solid flex flex-col gap-4 items-start justify-start sm:px-5 px-8 py-4 rounded-lg w-full">
                ...
                <div className="bg-black-900_01 flex flex-1 flex-col items-center justify-between px-4 py-2 rounded-lg w-full">
                  <div className="flex flex-col items-center justify-start max-w-[795px] w-full">
                    <div className="flex flex-col items-start justify-start w-full">
                      <div className="flex md:flex-col flex-row gap-[37px] items-center justify-between w-[98%] md:w-full">
                        <div className="flex flex-col items-start justify-start w-[49%] md:w-full">
                          ...
                          <div className="flex flex-row gap-4 items-center justify-start w-auto">
                            ...
                            <Text
                              className="bg-black-900_01 capitalize justify-center pb-1 pt-[7px] px-1 rounded text-pink-300 text-xs tracking-[0.60px] w-auto"
                              size="txtRalewayRomanSemiBold12Pink300"
                            >
                              sugestion
                            </Text>
                            <Text
        ...
        <div className="flex flex-col font-inter items-center mt-[83px] w-full">
...
export default ForumcodexsuggestionPage;
