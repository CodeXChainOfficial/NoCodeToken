...
const ForumcodexDiscussiondefaultPage: React.FC = () => {
  return (
    <>
      <div className="bg-black-900 flex flex-col font-raleway items-center justify-start mx-auto w-full">
        ...
        <div className="flex md:flex-col flex-row gap-8 items-start justify-start max-w-[1440px] mt-8 md:px-10 px-20 sm:px-5 w-full">
            ...
            <div className="bg-black-900_01 border-l-[10px] border-light_blue-500 border-solid flex flex-col gap-4 items-start justify-start sm:px-5 px-8 py-4 rounded-lg w-full">
              ...
              <div className="flex flex-row gap-4 items-center justify-between w-full">
                ...
                <Button className="bg-black-900_01 flex h-6 items-center justify-center p-[7px] rotate-[180deg] w-6">
                  <Img src="images/img_arrowup_white_a700.svg" alt="arrowup" />
                </Button>
              </div>
            </div>
          </div>
          <div className="flex flex-1 flex-col gap-4 items-start justify-start w-full">
            ...
            <div className="md:h-[565px] sm:h-[572px] h-[954px] p-4 relative w-full">
              ...
              <div className="absolute flex flex-1 flex-col gap-2 inset-x-[0] items-center justify-start mx-auto top-[2%] w-full">
        ...
        <Footer className="bg-gray-900 flex font-inter gap-8 items-center justify-center mt-[41px] px-20 md:px-5 py-4 w-full" />
      </div>
    </>
  );
};

export default ForumcodexDiscussiondefaultPage;
