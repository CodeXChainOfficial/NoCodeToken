        ...
        <div className="flex flex-col items-center mb-[213px] w-full">
          ...
          <div className="flex flex-col items-start justify-start max-w-7xl mt-[3px] mx-auto md:px-5 w-full">
            ...
            <div className="flex md:h-[1297px] h-[821px] sm:h-[848px] justify-end mt-[35px] relative w-full">
              <Button className="bg-gradient  capitalize cursor-pointer font-semibold mb-[166px] min-w-[70px] ml-auto mr-2.5 mt-auto py-[11px] rounded text-base text-center text-white-A700 tracking-[0.80px]">
                next
              </Button>
            ...
            <div className="flex flex-row gap-8 items-start justify-start md:ml-[0] ml-[1097px] mt-16 w-auto">
              ...
              <Button className="bg-gradient  capitalize cursor-pointer font-semibold min-w-[79px] py-[11px] rounded text-base text-center text-white-A700 tracking-[0.80px]">
                reset
              </Button>
            </div>
          </div>
