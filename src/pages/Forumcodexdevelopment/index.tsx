...
const ForumcodexdevelopmentPage: React.FC = () => {
  return (
    <>
      <div className="bg-black-900 flex flex-col font-raleway items-start justify-start mx-auto w-full">
        <div className="flex flex-col gap-8 items-center w-full">
          ...
          <div className="flex md:flex-col flex-row gap-8 items-start justify-start max-w-[1440px] md:px-10 px-20 sm:px-5 w-full">
            <div className="flex sm:flex-1 flex-col gap-4 items-start justify-start w-[401px] sm:w-full">
              ...
              <div className="bg-black-900_01 border-green-400 border-l-[10px] border-solid flex flex-col gap-4 items-start justify-start sm:px-5 px-8 py-4 rounded-lg w-full">
                      ...
                      <div className="flex md:flex-col flex-row md:gap-5 items-center justify-evenly w-[98%] md:w-full">
                        <div className="flex flex-col items-start justify-start w-[53%] md:w-full">
                          ...
                          <div className="flex sm:flex-col flex-row gap-4 items-start justify-start w-auto sm:w-full">
                            <Text
                              className="bg-black-900_01 capitalize justify-center pb-1 pt-[7px] px-1 rounded text-green-400 text-xs tracking-[0.60px] w-auto"
        ...
        <div className="flex flex-col items-end mt-[50px] md:px-10 sm:px-5 px-[77px] w-full">
        ...
        <div className="flex flex-col font-inter items-center mt-[43px] w-full">
...
export default ForumcodexdevelopmentPage;
