...
const MyaccountgeneraluserrewardtransactionallPage: React.FC = () => {
  ...
  const table5Columns = React.useMemo(() => {
    ...
    return [
      table5ColumnHelper.accessor("nameofproject", {
        cell: (info) => (
      ...
      table5ColumnHelper.accessor("time", {
        cell: (info) => (
          <Button className="bg-black-900_01 border border-black-900_01 border-solid capitalize cursor-pointer flex-1 font-medium py-[11px] text-base text-center text-white-A700_e5 tracking-[0.80px]">
            <div className="bg-black-900_01 border border-black-900_01 border-solid text-white-A700_e5">
              {info?.getValue()}
      ...
      table5ColumnHelper.accessor("earnedtoken", {
        cell: (info) => (
...
export default MyaccountgeneraluserrewardtransactionallPage;
