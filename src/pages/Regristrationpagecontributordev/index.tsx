...
const RegristrationpagecontributordevPage: React.FC = () => {
  return (
    <>
      <div className="bg-black-900 flex flex-col font-raleway gap-8 items-start justify-end mx-auto w-full">
        ...
        <div className="bg-black-900 flex flex-col items-start justify-start md:px-5 w-auto md:w-full">
...
export default RegristrationpagecontributordevPage;
