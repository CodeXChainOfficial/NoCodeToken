...
const MyaccountcheckpointsviewmorePage: React.FC = () => {
  ...
  const table3Columns = React.useMemo(() => {
    ...
    return [
      table3ColumnHelper.accessor("numberofpoints", {
        cell: (info) => (
      ...
      table3ColumnHelper.accessor("pointsearned", {
        cell: (info) => (
          <Button className="bg-black-900_01 border border-black-900_01 border-solid capitalize cursor-pointer font-medium py-[11px] text-base text-center text-white-A700_e5 tracking-[0.80px]">
            <div className="bg-black-900_01 border border-black-900_01 border-solid text-white-A700_e5">
              {info?.getValue()}
      ...
      table3ColumnHelper.accessor("latestpoints", {
        cell: (info) => (
          <Button className="bg-black-900_01 border border-black-900_01 border-solid capitalize cursor-pointer font-medium py-[11px] text-base text-center text-white-A700_e5 tracking-[0.80px]">
            <div className="bg-black-900_01 border border-black-900_01 border-solid text-white-A700_e5">
              {info?.getValue()}
      ...
      table3ColumnHelper.accessor("time", {
        cell: (info) => (
          <Button className="bg-black-900_01 border border-black-900_01 border-solid capitalize cursor-pointer font-medium py-[11px] text-base text-center text-white-A700_e5 tracking-[0.80px]">
            <div className="bg-black-900_01 border border-black-900_01 border-solid text-white-A700_e5">
              {info?.getValue()}
          ...
          <div className="flex flex-col gap-8 items-start justify-start w-full">
            <div className="flex flex-col gap-4 items-start justify-start py-4 w-auto md:w-full">
              <div className="bg-black-900_01 flex flex-row gap-2.5 items-center justify-between max-w-7xl sm:px-5 px-8 py-4 rounded-lg w-full">
                ...
                <Button
                  ...
                  onClick={() => navigate("/myaccounthome")}
                >
                  check detail
                </Button>
              </div>
            ...
            <div className="bg-black-900_01 flex flex-row gap-2.5 items-center justify-between sm:px-5 px-8 py-4 rounded-lg w-full">
              ...
              <Button
                className="common-pointer bg-green-400 capitalize cursor-pointer font-semibold min-w-[95px] py-1.5 rounded text-center text-white-A700 text-xs tracking-[0.60px]"
                onClick={() =>
                  navigate("/myaccountgeneraluserrewardtransaction")
                }
              >
                check detail
              </Button>
...
export default MyaccountcheckpointsviewmorePage;
