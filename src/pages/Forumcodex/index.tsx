  ...
  return (
    <>
      <div className="bg-black-900 flex flex-col font-raleway items-start justify-start mx-auto w-full">
        ...
        <div className="flex flex-col items-end mt-24 md:px-10 sm:px-5 px-[114px] w-full">
          <Button className="bg-deep_purple-A200 capitalize cursor-pointer font-semibold min-w-[110px] py-[11px] rounded-lg text-base text-center text-white-A700 tracking-[0.80px]">
            see more
          </Button>
        </div>
