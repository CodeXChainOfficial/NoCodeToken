...
const ForumcodexpullrequestalldetailPage: React.FC = () => {
  return (
    <>
      <div className="bg-black-900 flex flex-col font-raleway items-start justify-start mx-auto w-full">
        ...
        <div className="flex flex-col items-end mt-[606px] md:px-10 sm:px-5 px-[90px] w-full">
...
export default ForumcodexpullrequestalldetailPage;
