...
const MyaccountcontributedprojectsviewmoreOnePage: React.FC = () => {
            ...
            <div className="flex flex-col gap-4 items-start justify-start py-4 w-auto md:w-full">
              ...
              <div className="flex flex-col items-end justify-start sm:px-5 px-8 w-full">
                <Button
                  ...
                  onClick={() => navigate("/myaccountcontributeviewmore")}
                >
                  view more
                </Button>
              </div>
...
export default MyaccountcontributedprojectsviewmoreOnePage;
