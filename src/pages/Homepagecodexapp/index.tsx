...
import MyaccountdeveloperPage from "pages/Myaccountdeveloper";

const HomepagecodexappPage: React.FC = () => {
  const navigate = useNavigate();

  const handleButtonClick = () => {
    navigate("/Myaccountdeveloper"); // Replace with the actual path to MyaccountdeveloperPage
  };
              ...
              >
                ...
                <div className="flex flex-col items-center justify-start w-full">
                  <HomePageCodexAppColumnonboard
                    ...
                    registerdescription={
                      "As a veteran programmer, join CodeX&#39;s bounty program and contribute to building a sustainable no- code ecosystem "}
                      onboard="register" 
