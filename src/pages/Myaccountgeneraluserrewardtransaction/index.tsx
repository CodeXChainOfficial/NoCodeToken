...
const MyaccountgeneraluserrewardtransactionPage: React.FC = () => {
  ...
  const table4Columns = React.useMemo(() => {
    ...
    return [
      table4ColumnHelper.accessor("nameofproject", {
        cell: (info) => (
      ...
      table4ColumnHelper.accessor("time", {
        cell: (info) => (
          <Button className="bg-black-900_01 border border-black-900_01 border-solid capitalize cursor-pointer flex-1 font-medium py-[11px] text-base text-center text-white-A700_e5 tracking-[0.80px]">
            <div className="bg-black-900_01 border border-black-900_01 border-solid text-white-A700_e5">
              {info?.getValue()}
      ...
      table4ColumnHelper.accessor("earnedtoken", {
        cell: (info) => (
            ...
            <div className="flex flex-col gap-4 items-start justify-start py-4 w-auto md:w-full">
              ...
              <div className="flex flex-col items-end justify-start sm:px-5 px-8 w-full">
                <Button
                  ...
                  onClick={() =>
                    navigate("/myaccountgeneraluserrewardtransactionall")
                  }
                >
                  view more
                </Button>
...
export default MyaccountgeneraluserrewardtransactionPage;
