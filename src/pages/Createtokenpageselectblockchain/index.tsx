  ...
  return (
    <>
      <div className="bg-black-900 flex flex-col font-raleway mx-auto py-[83px] relative w-full">
            ...
            <div className="flex flex-col items-start justify-start w-auto md:w-full">
              <div className="flex md:flex-col flex-row gap-4 items-start justify-start max-w-[1216px] w-full">
                <div className="flex flex-1 flex-col gap-4 items-end justify-end w-full">
                  ...
                  <div className="bg-gradient  flex flex-col items-center justify-center px-4 py-2 rounded w-[305px]">
                    <Text
        ...
        <div className="bg-black-900 flex flex-col gap-8 items-center justify-start mb-auto mt-[-591px] mx-auto p-8 md:px-5 rounded-lg shadow-bs2 w-auto z-[1]">
          <div className="flex flex-row gap-8 items-center justify-between w-full">
            <div className="flex flex-col items-center justify-start w-auto">
              <Text
                ...
                size="txtRalewayRomanSemiBold32Lightblue500"
              >
                Select Blockchain
              </Text>
            </div>
          ...
          <div className="bg-black-900 flex flex-col gap-8 items-start justify-start rounded-lg shadow-bs2 w-auto md:w-full">
            <div className="flex flex-col items-center justify-start w-auto">
              <Text
                className="capitalize text-white-A700 text-xl tracking-[1.00px] w-auto"
                size="txtRalewayRomanSemiBold20WhiteA700"
